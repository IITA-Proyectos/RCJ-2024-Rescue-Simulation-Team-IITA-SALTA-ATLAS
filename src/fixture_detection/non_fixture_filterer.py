...
class NonFixtureFilter:
    def __init__(self) -> None:
        self.color_filters = (
            ...
            ColorFilter((0, 0, 30), (0, 0, 138)), # Obstacles   anteriores valores que funcionan:((0, 0, 30), (0, 0, 138))
            ColorFilter((0, 0, 8), (0, 2, 30)), # Outer Hole old value ((0, 0, 8), (0, 2, 30)),
            ColorFilter((0, 0, 105), (0, 0, 108)), # Inner Hole old value ((0, 0, 105), (0, 0, 108)),
